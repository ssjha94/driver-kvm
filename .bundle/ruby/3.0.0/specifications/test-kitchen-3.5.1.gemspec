# -*- encoding: utf-8 -*-
# stub: test-kitchen 3.5.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_development_dependency(%q<aruba>.freeze, [">= 0.11", "< 3.0"])
    s.add_development_dependency(%q<countloc>.freeze, ["~> 0.4"])
    s.add_development_dependency(%q<cucumber>.freeze, [">= 2.1", "< 8.0"])
    s.add_development_dependency(%q<fakefs>.freeze, ["~> 2.0"])
    s.add_development_dependency(%q<maruku>.freeze, ["~> 0.6"])
    s.add_development_dependency(%q<minitest>.freeze, ["~> 5.3", "< 5.16"])
    ...
    s.add_dependency(%q<net-scp>.freeze, [">= 1.1", "< 5.0"])
    s.add_dependency(%q<net-ssh>.freeze, [">= 2.9", "< 8.0"])
    ...
    s.add_dependency(%q<aruba>.freeze, [">= 0.11", "< 3.0"])
    s.add_dependency(%q<countloc>.freeze, ["~> 0.4"])
    s.add_dependency(%q<cucumber>.freeze, [">= 2.1", "< 8.0"])
    s.add_dependency(%q<fakefs>.freeze, ["~> 2.0"])
    s.add_dependency(%q<maruku>.freeze, ["~> 0.6"])
    s.add_dependency(%q<minitest>.freeze, ["~> 5.3", "< 5.16"])
